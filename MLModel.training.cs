...
namespace Person_identifier
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\matia\OneDrive\Escritorio\Programacion\.NET\person-identifier\data\person-identifier.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"person",outputColumnName:@"person")      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"person"}))      
